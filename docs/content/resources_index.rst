...
Complete example experiments demonstrating various Interactive Gym features. Each example includes full source code, detailed documentation, and instructions for customization.

All examples are located in the `interactive_gym/examples/ <https://github.com/chasemcd/interactive-gym/tree/main/interactive_gym/examples>`_ directory.
...
2. **Install Interactive Gym with server dependencies**:
...
1. **From the repository root**, run the example as a module:
   ...
   .. code-block:: bash
       ...
       python -m interactive_gym.examples.example_name.experiment_file
