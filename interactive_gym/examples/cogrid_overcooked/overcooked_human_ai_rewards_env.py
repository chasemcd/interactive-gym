...
from interactive_gym.examples.cogrid_overcooked import overcooked_env
...
POLICY_MAPPING = {
    ...
    1: "interactive_gym/examples/cogrid_overcooked/policies/ibc_1_ckpt_60.onnx",
}
...
def env_creator(*args, **kwargs):
    ...
    return registry.make(
        "Overcooked-CrampedRoom-RewardObs-Unshaped-V0", render_mode=None
    )
