...
start_scene = (
    ...
    .display(
        ...
        scene_body="Welcome to the overcooked environment demo!",
    )
)
...
search_rescue_gym_scene = (
    ...
    .pyodide(
        ...
        environment_initialization_code_filepath="interactive_gym/examples/cogrid/overcooked_example_intialization.py",
